...
/*
            Department d1 = new Department(8, "Computers");
            Department d2 = new Department(9, "Eletronicsn");
            Department d3 = new Department(10, "Fashion");
            Department d4 = new Department(11, "Books");

            Seller s1 = new Seller(1, "Bob", "bob@gmail.com", new DateTime(2000, 01, 01), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria", "maria@gmail.com", new DateTime(2000, 02, 02), 2000.0, d2);
            Seller s3 = new Seller(3, "Alex1", "alex1@gmail.com", new DateTime(2000, 03, 03), 3000.0, d1);
            Seller s4 = new Seller(4, "Martha", "martha@gmail.com", new DateTime(2000, 04, 04), 4000.0, d4);
            Seller s5 = new Seller(5, "Donald", "donald@gmail.com", new DateTime(2000, 05, 05), 5000.0, d3);
            Seller s6 = new Seller(6, "Alex2", "alex2@gmail.com", new DateTime(2000, 06, 06), 6000.0, d2);
            ...
            _context.AddRange(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20,
